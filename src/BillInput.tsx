const BillInput = (props: any) => {
  return (
    <div className="pb-12">
      ...
      <label className="relative before:absolute before:left-6 before:top-0 before:bottom-0 before:w-10 before:mr-2 before:bg-[url('/images/icon-dollar.svg')] before:bg-no-repeat"></label>
      <input
        value={props.bill}
